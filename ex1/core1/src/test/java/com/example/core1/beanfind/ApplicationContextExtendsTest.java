...
import com.example.core1.discount.RateDiscountPolicy;
...
public class ApplicationContextExtendsTest {
    ...
    @Test
    @DisplayName("부모 이름으로 조회시 자식이 둘 이상 있으면 중복 오류가 발생함")
